<?php
	$link=mysqli_connect("Localhost", "andrwkpk_andrew","koreanguy94","andrwkpk_GymBet");
   		...
   		<div class="block-1-3 block-s-1-2 block-mob-full">
   			<div class="bgrid">
   					<div class="image-part">
   						<img class='pic' src="images/andrew.jpg" alt="">
   					</div>
   			...
   			<div class="bgrid">
   					<div class="image-part">
   						<img class='pic' src="images/sahrah.jpg" alt="">
   					</div>
   					<div class="demo-title">
   						<h3>SAHRAH</h3>
   						<form id="myform" name="myform" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
